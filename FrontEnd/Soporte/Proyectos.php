    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <form action='Historialcomentario.php' id='formulario' method='post' name='formulario'>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Historial de conversaciones </h3>
                    </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                            ...
                            if (index.idProyecto.length) {
                                ...
                                if (index.NombreProyecto != null) {
                                    $("#table1").append("<tr><td>" + index.NombreProyecto + "</td>" +
                                        ...
                                        "<td><span type='button'  class='update btn btn-outline-success' data-dato='" + index.idProyecto + "'>Seleccionar</span></td>" +
                                        "</tr>"
                        ...
                        $(".update").click(function() {
                            ...
                            document.getElementById("variable").value = idProyecto;
