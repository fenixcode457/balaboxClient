            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Actualizar cotización</h3>
                            ...
                            <div class="card-body">
                                <form onsubmit="return false;" id="formUpload">
                                    ...
                                    <div class="d-flex flex-row-reverse">
                                        <div class="p-2">
                                            <button type="submit" onclick="postdata()" id="prueba" class="btn btn-primary">Actualizar</button>
                                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function getTipo() {
                ...
                $.ajax({
                    ...
                    url: "./../../Backend/Cotizacion.php/cotizacionid/" + myvar,
                    ...
                    success: function(response) {
                        $.each(JSON.parse(response), function(i, index) {
                            ...
                            if (index.idCotizacion.length) {
                                ...
                                $("#nombreproyecto").val(index.TituloDelProyecto);
                                $("#tipo").val(index.Servicio);
                                $("#giroempresa").val(index.GiroEmpresa);
                                $("#explicacion").val(index.Explicacion);
                                $("#comentario").val(index.Comentario);
        ...
        function postdata() {
            $("#formUpload").submit(function(e) {
                ...
                $.ajax({
                    url: "http://localhost/estadia/backend/Cotizacion.php/cotizacion/"+ myvar,
                    type: "put",
