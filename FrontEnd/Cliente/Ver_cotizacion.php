        ...
        $(document).ready(function() {
            ...
            function getCotizaciones() {
                ...
                $.ajax({
                    ...
                    url: "./../../Backend/Cotizacion.php/cotizacion/" + idUsuario,
                    type: "get",
                    success: function(response) {
                        ...
                        $(".update").unbind("click").click(function() {
                            ...
                            document.getElementById("variable").value = idEmpresa;
                                ...
                                .then((willDelete) => {
                                    if (willDelete) {
                                        ...
                                        $.ajax({
                                            ...
                                            url: "http://localhost/estadia/Backend/Cotizacion.php/cotizacion/" + $(this).data("cotizacion"),
                                            type: "delete",
                                            success: function(response) {
                                                $("#table1").html("<tr><th><b>Proyecto</b></th><th><b>Tipo</b></th><th><b>Actualizar</b></th><th><b>Eliminar</b></th></tr>");
                                                getCotizaciones();
    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <form action='Act_cotizacion.php' id='formulario' method='post' name='formulario'>
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Cotizaciones</h3>
                    
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Cotizaciones registradas</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
