            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Panel proyectos</h3>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-xl-4">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary font-weight-bold m-0">Ticket</h6>
                                    <div class="dropdown no-arrow"><button class="btn btn-link btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button"><i class="fas fa-ellipsis-v text-gray-400"></i></button>
                                        <div role="menu" class="dropdown-menu shadow dropdown-menu-right animated--fade-in">
                                            <p class="text-center dropdown-header">dropdown header:</p><a role="presentation" class="dropdown-item" href="#"> Action</a><a role="presentation" class="dropdown-item" href="#"> Another action</a>
                                            <div class="dropdown-divider"></div><a role="presentation" class="dropdown-item" href="#"> Something else here</a>
                                ...
                                <div class="card-body">
                                    <form id="form1">
                                        ...
                                        <label for="">Matricula de proyecto:</label>
                                        ...
                                        <br>
                                        <button type="submit" onclick="posticket()" class="btn btn-primary">Enviar</button>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        $(document).ready(function() {
            ...
            function getDatos() {
                ...
                $.ajax({
                    ...
                    url: "./../../Backend/Usuario.php/datos/" + myvar,
                    type: "get",
                    success: function(response) {
                        $.each(JSON.parse(response), function(i, index) {
                            ...
                            if (index.idUsuario.length) {
                                ...
                                if (index.NombreProyecto != null) {
                                    $("#table1").append("<tr><td>" + index.NombreProyecto + "</td>" +
                                        "<td>" + arregloFunciones[index.Tipo - 1] + "</td>" +


                                        "<td><span type='button'  class='registrar btn btn-outline-success' data-dato='" + index.idProyecto + "'>Seleccionar</span></td>" +
                                        "</tr>"


                                    );
                                } else {
                                    swal("No tienes proyecto", "Contacta con soporte", "error");
                                }
                            }
