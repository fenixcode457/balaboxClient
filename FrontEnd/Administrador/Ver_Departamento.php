                    ...
                    success: function(response) {
                        $.each(JSON.parse(response), function(i, index) {
                            ...
                            if (index.idTipoUsuario.length) {
                                $("#table1").append("<tr><td>" + index.Tipo_usuario + "</td>" +
                                    "<td>" + index.Descripcion + "</td>" +

                                    "<td><span type='button' class='delete btn btn-outline-danger' data-departamento='" + index.idTipoUsuario + "'>Eliminar</span></td>" +
                                    "<td><span type='button'  class='update btn btn-outline-primary' data-departamenupdate='" + index.idTipoUsuario + "'>Actualizar</span></td>" +
                                ...
                                .then((willDelete) => {
                                    if (willDelete) {
                                        ...
                                        $.ajax({
                                            ...
                                            url: "http://localhost/estadia/Backend/Tipousuario.php/departamento/" + $(this).data("departamento"),
                                            type: "delete",
                                            success: function(response) {
                                                $("#table1").html("<tr><th><b>Nombre departamento</b></th><th><b>Descripción</b></th><th><b>Eliminar</b></th></tr>");
                                                getDepartamento();
                        ...
                        $(".update").unbind("click").click(function() {
                            var idTipoUsuario = $(this).data("departamenupdate");

                            document.getElementById("variable").value = idTipoUsuario;
    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <form action='Act_Departamento.php' id='formulario' method='post' name='formulario'>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Registrar Departamento</h3>
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Departamentos registrados</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
