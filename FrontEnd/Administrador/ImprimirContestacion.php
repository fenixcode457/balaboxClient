...
$id = $_POST['idMatricula'];  // variable pasada por el formulario imprimirContestacion.php

$costo = $_POST['costo']; // variable pasada por el formulario imprimirContestacion.php

$explicacion = $_POST['explicacion'];// variable pasada por el formulario imprimirContestacion.php
...
$pdf->SetFont('Arial','', 12);
$pdf->SetXY(70, 170);
$pdf->MultiCell(60, 5, utf8_decode("$".$costo), 1, 'C');
...
$pdf->SetFont('Arial','', 12);
$pdf->SetXY(10, 200);
$pdf->MultiCell(190, 8, utf8_decode($explicacion), 1, 'J');
