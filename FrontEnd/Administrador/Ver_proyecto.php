                    ...
                    success: function(response) {
                        $.each(JSON.parse(response), function(i, index) {
                            ...
                            if (index.idProyecto.length) {
                                ...
                                if (index.Eliminar == 0) {
                                    $("#table1").append("<tr><td>" + index.NombreProyecto + "</td>" +
                                        "<td>" + index.FechaEntrega + "</td>" +
                                        "<td>" + arregloFunciones[index.Tipo - 1] + "</td>" +
                                        "<td><span type='button' class='delete btn btn-outline-danger' data-delete='" + index.idProyecto + "'>Eliminar</span></td>" +
                                        "<td><span type='button'  class='update btn btn-outline-primary' data-usuario='" + index.idProyecto + "'>Actualizar</span></td>" +
                                        "</tr>"
                                ...
                                .then((willDelete) => {
                                    if (willDelete) {
                                        ...
                                        $.ajax({
                                            ...
                                            url: "http://localhost/estadia/Backend/Proyecto.php/eliminar/" + $(this).data("delete"),
                                            type: "put",
                                            ...
                                            success: function(response) {
                                                $("#table1").html("<tr><th><b>Nombre proyecto</b></th><th><b>Fecha entrega</b></th><th><b>Tipo</b></th><th><b>Modificar</b></th><th><b>Eliminar</b></th></tr>");
                                                getProyectos();
    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <form action='Act_proyecto.php' id='formulario' method='post' name='formulario'>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Proyectos registrados</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
