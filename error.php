    ...
    <main class="page lanidng-page">
        <div class="container div-center main-container">
            ...
            <div class="border rounded shadow-sm">
                <h1 class="d-xl-flex justify-content-xl-center">Error.</h1>
            </div>
            <section class="portfolio-block block-intro">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-lg-5 offset-lg-1 text">
                            <h4 class="shadow-sm">Erro de inicio de sesión</h4>
                       
                                <!-- poner le javascript para leer el login-->
                                <br>
                                <h6 class="d-xl-flex justify-content-xl-start">La contraseña no existe o el email no coinciden con ninguna cuenta, revisar estado de su cuenta.</h6>
                                
                                <br>
                                <button class="btn btn-outline-primary shadow-sm" onclick="location.href='index.php'">Regresar</button> <!-- cambiar por el inicio de el archivo de configuracion-->
                                 &nbsp;
                                <button class="btn btn-outline-primary shadow-sm" type="submit" role="button" href="#">Recuperar contraseña</button>
                        ...
                        <div class="col">
                            <div class="carousel slide" data-ride="carousel" id="carousel-1">
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active"><img class="w-100 d-block img-borde" src="assets/img/Imagenes/image4.jpg" alt="Slide Image"></div>
                                    <div class="carousel-item"><img class="w-100 d-block img-borde" src="assets/img/Imagenes/image2.jpg" alt="Slide Image"></div>
                                    <div class="carousel-item"><img class="w-100 d-block img-borde" src="assets/img/Imagenes/image6.jpg" alt="Slide Image"></div>
                                </div>
