...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Actualizar Departamento</h3>
                            ...
                            <form id="form" data-producto="0">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="">Matrícula del departamento</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="Tipo_usuario" id="departamento" onkeypress="return soloLetras(event)">
                                    </div>
                                    <br>
                                    <div class="form-group col-md-10">
                                        <label for="">Descripción:</label>
                                        <textarea name="Descripcion" id="descripcion" class="form-control" placeholder="texto" onkeypress="return soloLetras(event)"></textarea>
                                    </div>
                                </div>
                                <div class="d-flex flex-row-reverse">
                                    <div class="p-2">
                                        <button type="submit" onclick="putdata()" class="btn btn-primary">Registrar</button>
                                    </div>
    ...
    <script>
        ...
        var myvar = <?php echo $_POST['variable']; ?>;
        $(document).ready(function() { // funcion para llenar el select con la llave foranea de usuarios
            ...
            function getTipo() {
                ...
                $.ajax({
                    ...
                    url: "http://localhost/estadia/Backend/TipoUsuario.php/departamento/" + myvar,
                    type: "get",
                    success: function(response) {
                        $.each(JSON.parse(response), function(i, index) {
                            ...
                            if (index.idTipoUsuario.length) {
                                ...
                                $("#departamento").val(index.Tipo_usuario);
                                $("#descripcion").val(index.Descripcion);
        ...
        function putdata() {  //Función para actualizar
            $("#form").submit(function(e) {
                e.preventDefault();
                $.ajax({
                     // Url pasando el para metro del id del del departamento
                    url: "http://localhost/estadia/backend/TipoUsuario.php/departamento/" + $("#matricula").val(), 
                    type: "put",
                    ...
                    success: function(response) { // Mensaje de verificacion 
