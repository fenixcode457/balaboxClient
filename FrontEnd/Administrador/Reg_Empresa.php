...
<body id="page-top">
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <form onsubmit="return false;" id="formUpload">
                                ...
                                <div class="d-flex flex-row-reverse">
                                    <div class="p-2">
                                        <button type="submit" onclick="postdataUsuario()" class="btn btn-primary">Registrar</button>
                                    </div>
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Formulario de registro de empresa.</p>
                        </div>
                        <div class="card-body">
                            <form id="form1">
        ...
        <script>
                        ...
                        success: function(response) {
                            $.each(JSON.parse(response), function(i, index) {
                                ...
                                if (index.idEmpresa.length) {
                                    ...
                                    arreglo.push(index.NombreEmpresa);
            ...
            /* -------------------------------------------------------- */
            // Función para inserta el usuario.
            /*-----------------------------------------------------------*/
            //insercion de imagen
            ...
            function postdata() {
                CadenaTexto = $("#nombrempresa").val();
                CadenaTexto = PrimeraMayuscula(CadenaTexto.toLowerCase());
                $("#nombrempresa").val(CadenaTexto);

                if (arreglo.includes(CadenaTexto)) { // funcion para validar doble registro dsi es verdadero no se inserta si es falso se insertar
                    ...
                    $("#form1").submit(function(e) {
                        ...
                        $.ajax({
                            ...
                            error: function(xhr, ajaxOptions, thrownError) {
                                ...
                                swal("Ingresa otro nombre para la empresa", "Doble registro", "error");
                    ...
                    // llamada de la funcion para  convertir mayuscula la primera letra
                    ...
                    $("#form1").submit(function(e) {
                        ...
                        $.ajax({
                            url: "http://localhost/estadia/Backend/Empresa.php/empresa",
                            type: "post",
                            data: {

                                NombreEmpresa: CadenaTexto,
