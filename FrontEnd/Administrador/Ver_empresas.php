                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $.each(JSON.parse(response), function(i, index) {
                            ...
                            if (index.idUsuario.length && index.Eliminar == 0) {
                                $("#table1").append("<tr><td>" + index.Nombre + "</td>" +
                                    "<td>" + index.ApellidoP + "</td>" +
                                    "<td>" + index.ApellidoM + "</td>" +
                                    "<td>" + index.Email + "</td>" +
                                    "<td>" + index.NombreEmpresa + "</td>" +
                                    "<td><span type='button'  class='update btn btn-outline-primary' data-empresa='" + index.idEmpresa + "'>Actualizar</span></td>" +
    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <form action='Act_Empresa.php' id='formulario' method='post' name='formulario'>
