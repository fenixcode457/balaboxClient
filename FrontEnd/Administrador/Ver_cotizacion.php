        ...
        $(document).ready(function() {
            ...
            function getDepartamento() {
                ...
                $.ajax({
                    ...
                    url: "http://localhost/estadia/Backend/Cotizacion.php/cotizacion", // agregar boton  para contestar el pdf 
                    type: "get",
                    success: function(response) {
                        $.each(JSON.parse(response), function(i, index) {

                            if (index.idCotizacion.length) {
                                $("#table1").append("<tr><td>" + arregloFunciones[index.Servicio - 1] + "</td>" +
                                    "<td>" + index.TituloDelProyecto + "</td>" +
                                    "<td><span type='button'  class='update btn btn-outline-success' data-departamenupdate='" + index.idCotizacion + "'>Imprimir</span></td>" +
                                    "<td><span type='button'  class='contestar btn btn-outline-primary' data-contestacion='" + index.idCotizacion + "'>Contestar</span></td>" +
                        ...
                        $(".update").unbind("click").click(function() {
                            var cotizacion = $(this).data("departamenupdate");

                            document.getElementById("variable").value = cotizacion;
                        ...
                        $(".contestar").unbind("click").click(function() {
                            var cotizacion = $(this).data("contestacion");

                            document.getElementById("variable2").value = cotizacion;
                            submitDetailsForm2(); //funcion pora enviar el id al actualizar
    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <form action='Imprimir.php' id='formulario' method='post' name='formulario'>
                    <input id='variable' name='variable' type='hidden' />


                </form>

                <form action='Contestacion.php' id='contestar' method='post' name='contestacion'>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Ver Cotización</h3>
                        <a class="btn btn-warning text-dark btn-sm d-none d-sm-inline-block" role="button" href="Reg_Departamento.php">
                            <i class="fas fa-industry fa-sm text-black-50"></i>&nbsp;Registrar Departamento</a>
                    </div>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Cotizaciones registrados</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table" id="table1">
                                    <tr>
                                        <th><b>Servicio</b></th>
                                        <th><b>Titulo del proyecto</b></th>
                                        <th><b>Imprimir</b></th>
                                        <th><b>Formulario</b></th>
